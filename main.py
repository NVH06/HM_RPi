...
db_backup_file = fr"C:\Users\Nils\Documents\Projects\Housing_Market\hm_backup\{date_name}_hm_backup.sql"   ### change to directory path ###
log_file = fr"C:\Users\Nils\Documents\Projects\Housing_Market\log\{date_name[:4]}_hm_log.txt"   ### change to directory path ###
...
if __name__ == "__main__":
    ...
    try:
        ...
        # LOG FILE
        log(log_file, RpiHost, zip_codes, pre_filter_count, total_count, sale_count, rent_count, med_buy, med_rent)
